...
export class AccountController {
    ...
    async create(req: Request, res: Response):Promise<Account> {
        const account = new Account(req.body._id, req.body.email, req.body.language, req.body.name);
    ...
    async update(req: Request, res: Response, id: string):Promise<Account> {
        const account = new Account(null, req.body.email, req.body.language, req.body.name);
